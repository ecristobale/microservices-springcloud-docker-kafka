...
insert into web_site(id_company, "name", category, description)
values(7, 'Java', 'SERVICES', 'Is a language program');
insert into web_site(id_company, "name", category, description)
values(7, 'OracleCloud', 'CLOUD_COMPUTING', 'Is a cloud computing');
insert into web_site(id_company, "name", category, description)
values(8, 'Cisco networks', 'SERVICES', 'Is a service networks');
insert into web_site(id_company, "name", category, description)
values(9, 'Smartphone', 'DEVICES', 'Is a communication devices');
insert into web_site(id_company, "name", category, description)
values(10, 'Playstation', 'DEVICES', 'Is a video console');
insert into web_site(id_company, "name", category, description)
values(11, 'Nintendo', 'DEVICES', 'Is a video console');