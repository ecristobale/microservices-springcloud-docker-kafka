package com.ecristobale.gateway.filters;

import com.ecristobale.gateway.dtos.TokenDto;
...
public class AuthFilter implements GatewayFilter {
    ...
    private static final String AUTH_VALIDATE_URI = "http://ms-auth-server:3030/auth-server/auth/jwt";
